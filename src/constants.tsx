...
import { ArrowUpCircle, Weight, Box, Music, MapPin, Truck as TruckIcon } from "lucide-react";

export const INITIAL_EMPLOYEES: Employee[] = [
  { id: "e1", name: "James Wilson", initials: "JW", hasLicense: true, phone: "(904) 555-0101", rank: 9, noDayOff: false },
  { id: "e2", name: "Sarah Miller", initials: "SM", hasLicense: false, phone: "(904) 555-0102", rank: 7, noDayOff: false },
  { id: "e3", name: "Mike Thompson", initials: "MT", hasLicense: true, phone: "(904) 555-0103", rank: 10, noDayOff: false },
  { id: "e4", name: "David Lee", initials: "DL", hasLicense: true, phone: "(904) 555-0104", rank: 8, noDayOff: false },
  { id: "e5", name: "Chris Evans", initials: "CE", hasLicense: false, phone: "(904) 555-0105", rank: 5, noDayOff: false },
  { id: "e6", name: "Emma Watson", initials: "EW", hasLicense: false, phone: "(904) 555-0106", rank: 6, noDayOff: false },
  { id: "e7", name: "Robert Downey", initials: "RD", hasLicense: true, phone: "(904) 555-0107", rank: 9, noDayOff: false },
  { id: "e8", name: "Scarlett J.", initials: "SJ", hasLicense: false, phone: "(904) 555-0108", rank: 7, noDayOff: false },
  { id: "e9", name: "Mark Ruffalo", initials: "MR", hasLicense: true, phone: "(904) 555-0109", rank: 8, noDayOff: false },
  { id: "e10", name: "Jeremy Renner", initials: "JR", hasLicense: true, phone: "(904) 555-0110", rank: 4, noDayOff: false },
  { id: "e11", name: "Paul Rudd", initials: "PR", hasLicense: false, phone: "(904) 555-0111", rank: 6, noDayOff: false },
  { id: "e12", name: "Brie Larson", initials: "BL", hasLicense: true, phone: "(904) 555-0112", rank: 8, noDayOff: false },
  { id: "e13", name: "Tom Holland", initials: "TH", hasLicense: false, phone: "(904) 555-0113", rank: 3, noDayOff: false },
  { id: "e14", name: "Zendaya Coleman", initials: "ZC", hasLicense: true, phone: "(904) 555-0114", rank: 7, noDayOff: false },
];
...
export const INITIAL_JOBS: Job[] = [
  ...
  // ⭐ DEMO WARNING JOB (should glow yellow)
  {
    id: "j3",
    time: "11:30–1:30",
    ...
    warning: true,
    warningNote: "Packing + multiple trucks required. Dispatcher must confirm crew size & staging plan.",
  ...
  },
  {
    ...
    status: JobStatus.READY,
    warning: false,
    scheduledArrival: "2026-01-03T13:45:00-05:00",
  },
  {
    id: "j6",
    time: "Afternoon (3:00)",
    ...
    status: JobStatus.READY,
    warning: false,
    scheduledArrival: "2026-01-03T15:00:00-05:00",
  },
  {
    id: "j7",
    time: "3:30 PM",
    ...
    status: JobStatus.READY,
    warning: false,
    scheduledArrival: "2026-01-03T15:30:00-05:00",
  },
  {
    id: "j8",
    time: "4:00 PM",
    ...
    status: JobStatus.READY,
    warning: false,
    scheduledArrival: "2026-01-03T16:00:00-05:00",
  },
  {
    id: "j9",
    time: "4:30 PM",
    ...
    status: JobStatus.READY,
    warning: false,
    scheduledArrival: "2026-01-03T16:30:00-05:00",
  },
  {
    id: "j10",
    time: "5:00 PM",
    ...
    status: JobStatus.READY,
    warning: false,
    scheduledArrival: "2026-01-03T17:00:00-05:00",
  },
];
...
export const FLAG_ICONS: Record<JobFlag, React.ReactNode> = {
  ...
  // NEW (reuse existing icons for now)
